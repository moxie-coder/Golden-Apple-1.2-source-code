...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var charVisi:FlxButton = new FlxButton(120, 450, 'Toggle Char Visibility', function() char1.visible = char2.visible = !char2.visible);
	...
	function updateHeads():Void
	{
		...
		{
			leftIcon.changeIcon(char1.iconName);
			rightIcon.changeIcon(char2.iconName);
		}
		else
		{
			leftIcon.changeIcon(char2.iconName);
			rightIcon.changeIcon(char1.iconName);
		}
	}
