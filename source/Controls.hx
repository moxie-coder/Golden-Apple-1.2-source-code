...
enum abstract Action(String) to String from String
{
	...
	var CHEAT = "cheat";
	var APPLE = "apple";
	var APPLE_P = "apple-press";
	var APPLE_R = 'apple-release';
}
#else
@:enum
...
class Controls extends FlxActionSet
{
	...
	var _apple = new FlxActionDigital(Action.APPLE);
	var _appleP = new FlxActionDigital(Action.APPLE_P);
	...
	public var APPLE(get, never):Bool;

	inline function get_APPLE()
		return _apple.check();

	public var APPLE_P(get, never):Bool;

	inline function get_APPLE_P()
		return _appleP.check();

	public var APPLE_R(get, never):Bool;

	inline function get_APPLE_R()
		return _appleR.check();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch (control)
		{
			...
			case APPLE:
				func(_apple, PRESSED);
				func(_appleP, JUST_PRESSED);
				func(_appleR, JUST_RELEASED);
			case ACCEPT:
